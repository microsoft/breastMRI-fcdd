...
Routine prediction and metadata-cache status messages omit dataset paths.
Configuration files, result artifacts, and error diagnostics can still contain
paths, so keep experiment outputs access-controlled.
